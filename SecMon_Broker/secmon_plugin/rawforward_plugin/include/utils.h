...
/** @file
 *  utils header for rawforward plugin
 */
...
/**
 *	Flags for Collector and Collector Set
 */
enum 
{
    COLLECTOR=0,
...
extern struct rule_hash *hash_table[HASH_TABLE_SIZE];
extern struct Collector_object *collector_obj_head;
extern int *raw_rule_futex;
